  ...
  <div class="shell">
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <NuxtLink to="/influence" class="ghost sm navlink" title="Influence de chaque catégorie de carte sur le combo">Influence des cartes</NuxtLink>
        ...
        <a
          class="ghost sm navlink"
          href="https://github.com/mcouzinet/Fantasticar"
          target="_blank"
